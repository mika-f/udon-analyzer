...
public class TheMethodSpecifiedForOverTheNetworkCannotStartWithAnUnderscoreAnalyzer : BaseDiagnosticAnalyzer
{
    public override DiagnosticDescriptor SupportedDiagnostic => DiagnosticDescriptors.TheMethodSpecifiedForOverTheNetworkCannotStartWithAnUnderscore;
    ...
    private static bool AnalyzeReceiverMembers(INamedTypeSymbol? symbol, string target)
    {
        ...
        return !candidates[0].Name.StartsWith("_");
    }
}