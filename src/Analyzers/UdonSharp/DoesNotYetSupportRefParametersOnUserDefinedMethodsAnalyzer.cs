...
public class DoesNotYetSupportRefParametersOnUserDefinedMethodsAnalyzer : BaseDiagnosticAnalyzer
{
    public override DiagnosticDescriptor SupportedDiagnostic => DiagnosticDescriptors.DoesNotYetSupportRefParametersOnUserDefinedMethods;
    ...
    private void AnalyzeMethodDeclaration(SyntaxNodeAnalysisContext context)
    {
        ...
        foreach (var parameter in declaration.ParameterList.Parameters.Where(parameter => parameter.HasModifier(SyntaxKind.RefKeyword)))
