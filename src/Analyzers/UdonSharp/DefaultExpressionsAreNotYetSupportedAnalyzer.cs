...
public class DefaultExpressionsAreNotYetSupportedAnalyzer : BaseDiagnosticAnalyzer
{
    public override DiagnosticDescriptor SupportedDiagnostic => DiagnosticDescriptors.DefaultExpressionsAreNotYetSupported;

    public override void Initialize(AnalysisContext context)
    {
        base.Initialize(context);
        context.RegisterSyntaxNodeAction(w => RunAnalyzer(w, true, AnalyzeDefaultExpression), SyntaxKind.DefaultExpression);
    }
