...
public class DoesNotYetSupportInParametersOnUserDefinedMethodsAnalyzer : BaseDiagnosticAnalyzer
{
    public override DiagnosticDescriptor SupportedDiagnostic => DiagnosticDescriptors.DoesNotYetSupportInParametersOnUserDefinedMethods;
    ...
    private void AnalyzeMethodDeclaration(SyntaxNodeAnalysisContext context)
    {
        ...
        foreach (var parameter in declaration.ParameterList.Parameters.Where(parameter => parameter.HasModifier(SyntaxKind.InKeyword)))
