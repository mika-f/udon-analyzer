...
public class DoesNotCurrentlySupportConstructorsOnBehavioursAnalyzer : BaseDiagnosticAnalyzer
{
    public override DiagnosticDescriptor SupportedDiagnostic => DiagnosticDescriptors.DoesNotCurrentlySupportConstructorsOnBehaviours;
    ...
    private void AnalyzeConstructorDeclaration(SyntaxNodeAnalysisContext context)
    {
        ...
        DiagnosticHelper.ReportDiagnostic(context, SupportedDiagnostic, constructor);
    }
}