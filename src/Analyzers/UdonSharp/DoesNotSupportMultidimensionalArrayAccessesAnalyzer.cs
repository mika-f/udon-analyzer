...
public class DoesNotSupportMultidimensionalArrayAccessesAnalyzer : BaseDiagnosticAnalyzer
{
    public override DiagnosticDescriptor SupportedDiagnostic => DiagnosticDescriptors.DoesNotSupportMultidimensionalArrayAccesses;
