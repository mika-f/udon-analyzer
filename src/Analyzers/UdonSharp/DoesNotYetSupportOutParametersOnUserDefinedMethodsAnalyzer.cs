...
public class DoesNotYetSupportOutParametersOnUserDefinedMethodsAnalyzer : BaseDiagnosticAnalyzer
{
    public override DiagnosticDescriptor SupportedDiagnostic => DiagnosticDescriptors.DoesNotYetSupportOutParametersOnUserDefinedMethods;
    ...
    private void AnalyzeMethodDeclaration(SyntaxNodeAnalysisContext context)
    {
        ...
        foreach (var parameter in declaration.ParameterList.Parameters.Where(parameter => parameter.HasModifier(SyntaxKind.OutKeyword)))
