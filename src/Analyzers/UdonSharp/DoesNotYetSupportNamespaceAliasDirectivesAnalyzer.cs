...
public class DoesNotYetSupportNamespaceAliasDirectivesAnalyzer : BaseDiagnosticAnalyzer
{
    public override DiagnosticDescriptor SupportedDiagnostic => DiagnosticDescriptors.DoesNotYetSupportNamespaceAliasDirectives;
