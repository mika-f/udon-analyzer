...
public static class AnalyzerOptionDescriptors
{
    ...
    public static readonly AnalyzerOptionDescriptor<string> UdonVirtualMachineVersion = new("udon_analyzer.virtual_machine", "auto");
    public static readonly AnalyzerOptionDescriptor<string> UdonSharpCompilerVersion = new("udon_analyzer.udon_sharp", "auto");
    public static readonly AnalyzerOptionDescriptor<string> CSharpLanguageFeature = new("udon_analyzer.csharp_version", "7.3");
