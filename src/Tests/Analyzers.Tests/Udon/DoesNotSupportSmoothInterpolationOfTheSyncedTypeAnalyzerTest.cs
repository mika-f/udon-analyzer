...
[Describe(typeof(DoesNotSupportSmoothInterpolationOfTheSyncedTypeAnalyzer), "VRC")]
public class DoesNotSupportSmoothInterpolationOfTheSyncedTypeAnalyzerTest : UdonSharpDiagnosticVerifier<DoesNotSupportSmoothInterpolationOfTheSyncedTypeAnalyzer>
{
    [Theory]
    [InlineData("byte")]
    [InlineData("uint")]
